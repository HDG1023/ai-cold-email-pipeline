...
## Campaign A — Raw Material Providers
...
Selling {{specific_ingredient_or_product}} on a spec sheet asks a lot of a buyer.
...
**Subject line options**
- One more thought on {{specific_ingredient_or_product}}
- A demo beats a data sheet
- Re: turning ingredients into proof
- What a concept product actually looks like

**Body**

Hi {{first_name}},

Following up on my note about putting {{specific_ingredient_or_product}} into a
finished concept product.

A quick example of how this tends to play out: a supplier sends their buyer a
small-batch lotion or serum built around their material, at the use level they
...
- Should I step back?
- Last note on {{specific_ingredient_or_product}}
- Bad timing?
...
I've reached out a couple of times about building {{specific_ingredient_or_product}}
into a finished concept product, so I'll assume the timing isn't right and leave it
there.

If {{company}} ever wants a working demo to put in front of buyers — something that
proves the material instead of describing it — my door is open. Just reply and
...
### Email B1 — Initial Outreach

**Subject line options**
- The hardest part of launching {{company}}
- A formula you actually own
- From idea to a real {{specific_ingredient_or_product}}
- Skipping the white-label trap
- {{first_name}}, the step between vision and product

**Body**

Hi {{first_name}},

The vision for {{company}} is the easy part. The wall most founders hit is the
...
**Subject line options**
- Custom vs. white-label for {{company}}
- Still thinking about your {{specific_ingredient_or_product}}?
- Re: a formula you own
- Where most skincare launches stall

**Body**

Hi {{first_name}},

Circling back on developing a custom {{specific_ingredient_or_product}} for {{company}}.

A lot of founders start with white-label because it's fast, then realize they've
...
I've reached out a couple of times about building a custom formula for {{company}},
so I'll take the hint that now isn't the moment.
